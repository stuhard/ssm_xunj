<template>
  <view class="page_patrol_report diy_table diy_table_tml" id="patrol_report_table">
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                    <uni-forms-item label="人员姓名" name="personnel_name">
                      <uni-easyinput type="text" v-model="query.personnel_name" placeholder="人员姓名" />
                    </uni-forms-item>
                    <uni-forms-item label="上报标题" name="report_title">
                      <uni-easyinput type="text" v-model="query.report_title" placeholder="上报标题" />
                    </uni-forms-item>
                    <uni-forms-item label="上报类型" name="report_type">
                      <uni-easyinput type="text" v-model="query.report_type" placeholder="上报类型" />
                    </uni-forms-item>
                        </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/patrol_report/view?" v-show="user_group == '管理员' || $check_action('/patrol_report/table','add') || $check_action('/patrol_report/view','add')">添加</navigator>
                            ...
                            <span>巡查人员</span>
								...
								<text>
									{{ get_user_patrol_personnel(o['patrol_personnel']) }}
													...
													<view v-if="1 && $check_field('get','personnel_name')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>人员姓名</span>
                          </view>
								...
								<text>
									{{ o["personnel_name"] }}
													...
													<view v-if="1 && $check_field('get','report_title')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>上报标题</span>
                          </view>
								...
								<text>
									{{ o["report_title"] }}
													...
													<view v-if="0 && $check_field('get','report_type')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>上报类型</span>
                          </view>
								...
								<text>
									{{ o["report_type"] }}
													...
													<view v-if="0 && $check_field('get','reporting_time')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>上报时间</span>
                          </view>
								...
								<text>
									{{ $toTime(o["reporting_time"],"yyyy-MM-dd hh:mm:ss") }}
								</text>
							</view>
										</view>
					</view>
													<view v-if="0 && $check_field('get','reporting_location')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>上报位置</span>
                          </view>
											<view class="diy_field diy_text text">
								<text>
									{{ o["reporting_location"] }}
								</text>
							</view>
										</view>
					</view>
													<view v-if="1 && $check_field('get','submit_images')" class="col">
						<view class="view">
                          <view class="diy_title" v-if=" false">
                            <span>上报图片</span>
                          </view>
											<view class="diy_field diy_img">
								<img :src="$fullUrl(o['submit_images'])" />
							</view>
										</view>
					</view>
													<view v-if="0 && $check_field('get','report_content')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>上报内容</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/patrol_report/table','del') || $check_action('/patrol_report/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/patrol_report/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/patrol_report/table','set') || $check_action('/patrol_report/view','set') || $check_action('/patrol_report/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
...
<script>
	...
	export default {
		...
		data() {
			return {
				// 获取数据地址
				url_get_list: "~/api/patrol_report/get_list?like=0",
				url_del: "~/api/patrol_report/del?",
